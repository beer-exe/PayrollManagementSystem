...
export const workScheduleApi = {
  ...
  updateChiTiet: (idChiTiet: string, loaiNgay: string, tenNgayNghi?: string, idCaLamViecMacDinh?: string): Promise<{ data: boolean; succeeded: boolean; message: string }> =>
    axiosClient.put(`${BASE_URL}/chi-tiet`, { idChiTiet, loaiNgay, tenNgayNghi, idCaLamViecMacDinh }),
};
