...
const menuItems: MenuItem[] = [
  ...
  },
  {
    ...
    children: [
      {
        path: "/dashboard/luong/luongtheochucvu",
        label: "Quản lý lương theo chức vụ",
        allowedRoles: ["HR"],
      }
    ],
  },
            ...
            {filteredMenuItems.map((item) => {
              ...
              const visibleChildren = item.children?.filter(child => {
                ...
                if (child.path === "/dashboard/danh-gia/duyet-danh-gia") {
                  if (userRole !== "HR" && !user?.hasDirectReports) return false;
                }
                return true;
              }) || [];
                  ...
                  {isDropdown ? (
                    <div>
                      <button
                        ...
                        className={`nav-item nav-item-dropdown group ${hasActiveChild ? "active" : ""}`}
                      ...
                      >
                        ...
                        {!isCollapsed && (
                          <svg
                            ...
                            viewBox="0 0 20 20"
                            fill="currentColor"
                            className={`w-4 h-4 shrink-0 ml-2 text-gray-400 transition-transform duration-200 ${isOpen ? "rotate-180" : ""}`}
                          >
