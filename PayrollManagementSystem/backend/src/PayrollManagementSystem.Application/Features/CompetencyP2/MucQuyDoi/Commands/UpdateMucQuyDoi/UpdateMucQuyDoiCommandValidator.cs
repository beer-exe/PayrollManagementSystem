...
{
    public class UpdateMucQuyDoiCommandValidator : AbstractValidator<UpdateMucQuyDoiCommand>
    {
        public UpdateMucQuyDoiCommandValidator()
        {
            RuleFor(v => v.IdQuyDoi).NotEmpty().WithMessage("Id cấu hình là bắt buộc.");
