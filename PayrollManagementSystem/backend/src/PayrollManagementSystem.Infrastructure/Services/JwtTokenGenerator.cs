    ...
    public class JwtTokenGenerator : IJwtTokenGenerator
    {
        ...
        public string GenerateAccessToken(TaiKhoan user)
        {
            ...
            Claim[]? claims = new[]
            {
                ...
                new Claim(JwtRegisteredClaimNames.UniqueName, user.TenTaiKhoan),
                new Claim(JwtRegisteredClaimNames.Email, user.NhanVien?.Email ?? string.Empty),
                new Claim(ClaimTypes.Role, user.VaiTro?.TenVaiTro ?? string.Empty),
