...
namespace PayrollManagementSystem.Infrastructure.Migrations
{
    ...
    [Migration("20260623065912_AddModuleDanhGiaNangLucP2")]
    partial class AddModuleDanhGiaNangLucP2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PayrollManagementSystem.Domain.Models.HeSoNangLucNhanVien", b =>
                {
                    b.Property<Guid>("IdHeSo")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                        .HasColumnName("id_he_so")
                        .HasDefaultValueSql("gen_random_uuid()");
                    ...
                    b.Property<Guid?>("IdPhieuDanhGia")
                        .HasColumnType("uuid")
                        .HasColumnName("id_phieu_danh_gia");
                    ...
                    b.HasKey("IdHeSo")
                        .HasName("he_so_nang_luc_nhan_viens_pkey");

                    b.HasIndex("Cccd");

                    b.HasIndex("IdPhieuDanhGia");

                    b.ToTable("he_so_nang_luc_nhan_viens", (string)null);
                });
            ...
            modelBuilder.Entity("PayrollManagementSystem.Domain.Models.KhungHieuSuatP3", b =>
                {
                    b.Property<Guid>("IdKpi")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("IdKpi")
                        .HasName("khung_hieu_suat_p3_pkey");

                    b.HasIndex("IdChucVu");

                    b.ToTable("khung_hieu_suat_p3", (string)null);
                });
            ...
            modelBuilder.Entity("PayrollManagementSystem.Domain.Models.KhungNangLucP2", b =>
                {
                    ...
                    b.Property<int>("DiemChuan")
                        .HasColumnType("integer")
                        .HasColumnName("diem_chuan");
            ...
            modelBuilder.Entity("PayrollManagementSystem.Domain.Models.HeSoNangLucNhanVien", b =>
                {
                    b.HasOne("PayrollManagementSystem.Domain.Models.NhanVien", "NhanVien")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("he_so_nang_lucs_cccd_fkey");

                    b.HasOne("PayrollManagementSystem.Domain.Models.PhieuDanhGiaNangLuc", "PhieuDanhGia")
                        .WithMany()
                        .HasForeignKey("IdPhieuDanhGia")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("he_so_nang_lucs_id_phieu_danh_gia_fkey");
            ...
            modelBuilder.Entity("PayrollManagementSystem.Domain.Models.KhungHieuSuatP3", b =>
                {
                    b.HasOne("PayrollManagementSystem.Domain.Models.ChucVu", "ChucVu")
                        .WithMany("KhungHieuSuats")
                        .HasForeignKey("IdChucVu")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("khung_hieu_suat_id_chuc_vu_fkey");
